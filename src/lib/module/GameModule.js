...
GameModule.kTaskLumberman = new CollectBuildingResourcesEffect({
  ...
  requirements: [GameModule.kWoodField.namespace],
  time: 1,
  allowedBuildings: [GameModule.kWoodField.namespace]
});

GameModule.kTaskMiner = new CollectBuildingResourcesEffect({
  name: 'Miner',
  namespace: 'task.basic.miner',
  requirements: [GameModule.kMine.namespace],
  time: 3,
  allowedBuildings: [GameModule.kMine.namespace]
});

GameModule.kTaskBlacksmith = new CollectBuildingResourcesEffect({
  name: 'Blacksmith',
  namespace: 'task.basic.blacksmith',
  requirements: [GameModule.kForge.namespace],
  time: 3,
