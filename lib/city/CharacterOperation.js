...
var CityEvent = require('./CityEvent.js').CityEvent;
...
export class CompleteBuildingOperation extends CharacterOperation {
  ...
  updateTime(deltaSeconds, parents) {
    ...
    if (!wasCompleted && this.completed) {
      ...
      updates.push(new CityEvent({
        type:CityEvent.kConsumedResourceEvent,
        object:resource
      }));
  ...
  export class InvestResourceInBuildingOperation extends CharacterOperation {
    ...
    updateTime(deltaSeconds, parents) {
      ...
      if (!wasCompleted && this.completed) {
        ...
        updates.push(new CityEvent({
          type:CityEvent.kSpendResourceEvent,
          object:resource
        }));
      ...
      while (true) {
        if (this.currentOperation === null) {
          ...
          if (futureOperation) {
            ...
            updates.push(new CityEvent({
              type:CityEvent.kCharacterOperationBeganEvent,
        ...
        if (this.currentOperation) {
          ...
          if (this.currentOperation.completed) {
            updates.push(new CityEvent({
              type:CityEvent.kCharacterOperationCompletedEvent,
              object:this.currentOperation
            }));
            this.currentOperation = null;
          } else {
            updates.push(new CityEvent({
              type:CityEvent.kCharacterOperationProgressEvent,
              object:this.currentOperation
            }));
          }
